...
namespace Webservice.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        {
            var response = AccountHelper.GetCollection(Database.DBContext, out HttpStatusCode stat, HostingEnvironment.IsDevelopment());
        ...
        {
            var resp = AccountHelper.Add(data, Database.DBContext, out HttpStatusCode stat, HostingEnvironment.IsDevelopment());
            HttpContext.Response.StatusCode = (int)stat;
            return resp;
        }
    }
